...
B-GEO-LAND-5: bh commit-staged admitted the nine bea_sainc heads (SAINC1/4/30
x national_us/bea_region/state_or_dc), extended config to 556, and published
the current generation (pointer 89eff6707864). But operational_status.json is
...
def main():
    ...
    with writer_lock.writer_lock("reconcile operational_status geo-land-5", REPO):
