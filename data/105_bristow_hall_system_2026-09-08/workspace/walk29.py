...
exec(open('walk9.py').read().split('BASE9=dict(BASE)')[0].replace("out=open('walk9_%s_%s.out'%(sys.argv[3],sys.argv[1]),'w')","out=open('walk29_%s.out'%sys.argv[1],'w')"))
...
def closer_C(D,n,s,A=20.0,c=3.0,u=3,need=1,k=1,pub_cc=12,cool=26):
    ...
    return calls
CD_=[8,6,5,4]; CN_=[4,3]; CS_=[30,25,20,15]
...
GRID=[('sahm',[0.55,0.50,0.45,0.43,0.40,0.3667,0.35]),('vl',[0.36,0.30,0.25,0.20,0.15,0.12]),('hline',[1.10,1.00,0.95,0.90,0.85,0.80]),
      ...
      ('look',[52,78,91,130]),('ic',[60,50,45]),('rst',[8,6,5,4]),('tst',[6,5,4,3]),('qst',[13,10,8,6]),('cD',[8,6,5,4,None]),('cn',[4,3]),('cs',[30,25,20,15]),
