"""WALK 67 - WALK 66 WITH LEG S'S MENU NARROWED TO ONE SETTING AND OFF (14 September 2026).
Pre-registered in PREREG-v340-ADDENDUM-2026-09-14.md before this was run.
...
Run:  python3 walk67.py 1962 2026 w67"""
...
_hdr = open('walk54.py').read().split(_MARK)[0].replace("walk54_%s.out", "walk67_%s.out")
...
GRID = GRID + [('warnw', [26, 13, None]), ('warnp', [95, 90, 85]),
               ('sset', [5, None])]   # safest first, by firing count
