"""WALK 66 - NEVER LATE AS A COUNT, WITH LEGS N AND S (14 September 2026).
...
Run:  python3 walk66.py 1962 2026 w66"""
...
_hdr = open('walk54.py').read().split(_MARK)[0].replace("walk54_%s.out", "walk66_%s.out")
...
GRID = GRID + [('warnw', [26, 13, None]), ('warnp', [95, 90, 85]),
               ('sset', [5, 3, 4, None])]   # safest first, by firing count
