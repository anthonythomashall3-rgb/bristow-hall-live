"""WALK 64 - NEVER LATE, AND ONE TO THIRTY-ONE DAYS EARLY (14 September 2026).
Pre-registered in PREREG-v338-ADDENDUM-2026-09-14.md before this was run.
...
Run:  python3 walk64.py 1962 2026 w64"""
...
_hdr = open('walk54.py').read().split(_MARK)[0].replace("walk54_%s.out", "walk64_%s.out")
...
EARLIEST = -31       # a month before: the far edge of the window
LATEST   = -1        # the day before the peak month ends: the near edge (widened from -7 by instruction)
