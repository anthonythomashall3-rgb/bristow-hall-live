...
_hdr = open('walk54.py').read().split(_MARK)[0].replace("walk54_%s.out", "walk94_%s.out")
...
GRID = GRID + [('warnw', [None]), ('warnp', [95, 90, 85]), ('newlegs', [None]), ('extra', [None])]   # WALK 97 / v3.57 (20 Sep 2026, collection 260): the rule without legs
