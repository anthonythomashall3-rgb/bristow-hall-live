...
def main():
    ...
    rc, out = run('python3 s2/versions.py')
    ok('the arithmetic has not moved under us', rc == 0, out)
    rc, out = run('python3 s2/shape_guard.py')
    ok('every feed is the shape it was', rc == 0, out)
