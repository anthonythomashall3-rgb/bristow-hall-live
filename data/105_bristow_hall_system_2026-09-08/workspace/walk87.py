"""WALK 87 - WALK 81'S LADDER WITH THE VETTED LEGS APPENDED; OBJECTIVE UNCHANGED (16 September 2026).

Pre-registered in PREREG-v348-2026-09-16.md before this was run.
...
watched them refused. This walk does not change it either -- it is the CONTROL: walk 81's ladder with
E, S, T, Z appended, so the only question it answers is whether the vetted legs add anything under the
objective as it stands. Walk 88 changes the tie-breaker.

Ladder, declared: None, A, AY, AYG, AYGJ, AYGJF, AYGJFE, AYGJFES, AYGJFEST, AYGJFESTZ.
Run:  python3 walk87.py 1962 2026 w87"""
...
_hdr = open('walk54.py').read().split(_MARK)[0].replace("walk54_%s.out", "walk87_%s.out")
