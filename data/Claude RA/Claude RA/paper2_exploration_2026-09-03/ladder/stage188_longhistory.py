"""Stage 188: the American record before 1948.  The ninety-five per cent lower bound on the
...
NBER=[("1857-06","1858-12"),("1860-10","1861-06"),("1865-04","1867-12"),("1869-06","1870-12"),
      ("1873-10","1879-03"),("1882-03","1885-05"),("1887-03","1888-04"),("1890-07","1891-05"),("1893-01","1894-06"),
...
IDX=pd.DatetimeIndex(pd.date_range("1853-01-01","1948-12-01",freq="MS"))
...
for sid,s in S.items():
    if s.index.min()>pd.Timestamp("1940-01-01"): continue
