...
chk('the memo section 2 opens with version 43 and the header is dated September 4, 2026',
    '**Evidence memo, version 43. Hall & Bristow recession program. September 4, 2026.**' in memo and '**Version 43 adopts LEG U' in memo and "**Version 42 puts a NUMBER on Rule 20" in memo and '**Version 41 (4 September 2026, small hours)' in memo and "**Version 40 carries out the three sweeps" in memo and "**Version 39 answers Anthony's question of the night" in memo and "**Version 38 continues the speed hunt under Anthony's clearance" in memo, True)
...
chk('the memo carries section 8l and the route docstring is at version 43 (version 39 plus leg U)', '## 8l. The fourth pass' in memo and 'DEFAULT (version 43 = version 39 plus leg U' in B.AMERICAN_ROUTE, True)
