...
V=[("tp_T31P10rs1","T=3,1;P=1,0;rsT=1;rsP=1;scope=tall-plevel"),("tp_T31P10","T=3,1;P=1,0;rsT=1;rsP=2;scope=tall-plevel"),
   ("tp_T31P01rs2","T=3,1;P=0,1;rsT=1;rsP=2;scope=tall-plevel")]
for tag,spec in V: run(tag,spec)
open('/tmp/refine_grid_in.log','a').write('ALLDONE3\n')
