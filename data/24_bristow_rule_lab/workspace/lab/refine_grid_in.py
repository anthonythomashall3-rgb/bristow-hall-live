...
V=[("ship","T=none;P=none"),("all_T11P10","T=1,1;P=1,0;rsT=1;rsP=2;scope=all"),("lvl_T11P10","T=1,1;P=1,0;rsT=1;rsP=2;scope=level"),
   ("all_T11only","T=1,1;P=none;rsT=1;rsP=2;scope=all"),("all_T11P11rs3","T=1,1;P=1,1;rsT=1;rsP=3;scope=all"),
   ("all_T11P11rs1","T=1,1;P=1,1;rsT=1;rsP=1;scope=all"),("all_T11P00rs2","T=1,1;P=0,0;rsT=1;rsP=2;scope=all"),
   ("all_T11rs2P10","T=1,1;P=1,0;rsT=2;rsP=2;scope=all"),("all_T10P10","T=1,0;P=1,0;rsT=1;rsP=2;scope=all"),
   ("all_T21P10","T=2,1;P=1,0;rsT=1;rsP=2;scope=all"),("all_T11P20","T=1,1;P=2,0;rsT=1;rsP=2;scope=all"),
   ("all_T11P10rs3","T=1,1;P=1,0;rsT=1;rsP=3;scope=all")]
for tag,spec in V: run(tag,spec)
open('/tmp/refine_grid_in.log','a').write('ALLDONE\n')
