...
fig.tight_layout(); fig.savefig('/home/claude/fig1.png',bbox_inches='tight'); plt.close(fig)
...
fig.tight_layout(); fig.savefig('/home/claude/fig2.png',bbox_inches='tight'); plt.close(fig)
