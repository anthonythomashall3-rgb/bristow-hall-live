...
fig.tight_layout(); fig.savefig('/home/claude/fig3.png',bbox_inches='tight'); plt.close(fig)

# Figure 4: Michez rule (authors' dashboard) + Sahm
mi=pd.read_csv('/home/claude/m_recession_indicator.csv',parse_dates=['Date']); mi.columns=['date','m']
...
fig.tight_layout(); fig.savefig('/home/claude/fig4.png',bbox_inches='tight'); plt.close(fig)
